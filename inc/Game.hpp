...
namespace gp {
    ...
    public:
        ...
        void Setup() {
            ...
            fig1.Stup(600, 500, 100, 98754, 4.15, 255, 0, 0);
            fig2.SetupT(300, 400, 80, 4, 20000); //98754
            fig3.SetupS(1000, 500, 120, 9875, 3.6);
        ...
        void GAME() {
            ...
            while (window.isOpen())
            {
                ...
                fig2.MoveT(t, 1280, 760);
                fig3.MoveS(t, 1280, 760);
